...
bot = TeleBot(token='5548267962:AAERPjKngOa2ao_Hcx5Md-vMMXGjLj3SUwA') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет!Значение какого слова ты бы хотел узнать? Я помогу тебе расшифровать сложные аббревиатуры и термины 🤓\nВведи интересующий термин, например, регресс', # текст сообщения
    )
